...
var Inspector = function ($) {
    ...
    var template = ""
        ...
        + "      <label>Selector:<input class='selector'></input></label>&nbsp&nbsp<label>Element #:<input class='nth'></input></label>"
...
(function() {
    ...
    css.setAttribute('href', 'file:///C:/Users/Haley/Documents/Jobs/Summer2013/6.mitx/web-inspector.css');
